            ...
            <div className="chat-leftsidebar">
              ...
              <div>
                <div className="px-3  rounded-2 mb-2">
                  <div className="d-flex align-items-center">
                    <div className="flex-grow-1">
                      <h6 className="mb-0">Instances</h6>
                    </div>
                    <div className="flex-shrink-0">
                        <UncontrolledDropdown>
              ...
              <div>
                <div className="px-3  rounded-2 mb-2">
                  <div className="d-flex align-items-center">
                    <div className="flex-grow-1">
                      <h6 className="mb-0">Longer than</h6>
                    </div>
                    <div className="flex-shrink-0">
                    ...
                    <li>
                      <Link to="#" className="unread-msg-user" >
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <p className="text-truncate mb-0">Car</p>
                          </div>
                          <div className="flex-shrink-0">
                                  <span>
                                    372
                    ...
                    <li>
                      <Link to="#" className="unread-msg-user" >
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <p className="text-truncate mb-0">Motorcycle</p>
                          </div>
                          <div className="flex-shrink-0">
                                  <span>
                                    187
                    ...
                    <li>
                      <Link to="#" className="unread-msg-user">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <p className="text-truncate mb-0">Sail Boat</p>
                          </div>
                          <div className="flex-shrink-0">
                                  <span>
                                    76
                    ...
                    <li>
                      <Link to="#" className="unread-msg-user">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <p className="text-truncate mb-0">Person</p>
                          </div>
                          <div className="flex-shrink-0">
                                  <span>
                                    42
                    ...
                    <li>
                      <Link to="#" className="unread-msg-user" href="/apps-chat">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <p className="text-truncate mb-0">Dog</p>
                          </div>
                          <div className="flex-shrink-0">
                                  <span>
                                    25
